  ...
  tables: [
    ...
    tableSchema({
      ...
      columns: [
        ...
        { name: 'img_url', type: 'string', default: '' },
        { name: 'verbose_title', type: 'string', default: '' },
        { name: 'verbose_description', type: 'string', default: '' },
        { name: 'verbose_img_url', type: 'string', default: '' },
        { name: 'profile_img_url', type: 'string', default: '' },
        { name: 'profile_url', type: 'string', default: '' },
    ...
    tableSchema({
      ...
      columns: [
        ...
        { name: 'type', type: 'string', default: 'DAILY' },
        ...
        { name: 'isExpire', type: 'boolean', default: false },
